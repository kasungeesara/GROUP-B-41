...
final List<Pubs> pubs = [
  Pubs(
    ...
    url: "https://www.attractionsinsrilanka.com/travel-directory/the-dutch-pub/",
  ),
  Pubs(
    name: 'British Pub ',
    city: 'Colombo',
    ...
    url: "http://www.pulse.lk/restaurant-reviews/british-pub-fish-n-chips-one-galle-face/",
  ),
  Pubs(
    name: 'Cheers Pub',
    city: 'Colombo',
    ...
    url: "https://www.cinnamonhotels.com/cinnamongrandcolombo/experiences/cheers",
  ),
  Pubs(
    name: 'Playtrix Pub',
    city: 'Colombo',
  ...
  Pubs(
    ...
    url: "https://www.yamu.lk/kamu/re-pub-lk/",
  ),
  Pubs(
    name: "Travellers'Bar",
    city: 'Colombo',
    ...
    url: "https://www.gallefacehotel.com/dining/travellers-bar/",
  ),
   Pubs(
    ...
    url: "https://www.therooftopguide.com/rooftop-bars-in-colombo/on14-rooftop-bar-and-lounge.html",
  ),
  Pubs(
    name: 'The Manchester',
    city: 'Colombo',
    ...
    url: "https://www.yamu.lk/kamu/the-manchester/",
  ),
  Pubs(
    ...
    url: "https://pulse.lk/pulse2022/restaurant-reviews/the-irish-bar-and-grill-cmb/",
  ),
  Pubs(
    name: 'Curve Bar',
    city: 'Colombo',
    ...
    url: "https://www.yamu.lk/kamu/curve/",
  ),
