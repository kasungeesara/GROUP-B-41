...
final List<CityBasedHotel> citybasedhotels = [
  CityBasedHotel(
    ...
    price: 120.0,
    rating: 5,
    address: "Srimath Kudarathwatta Mawatha,Kandy 20000.",
    tel: 0812 - 234 - 365,
    imagePath: "assets/chk1.jpg",
    description:
  ...
  CityBasedHotel(
    ...
    price: 170,
    rating: 5,
    address: "523C Colombo Main Rd, Galle 80280.",
    tel: 0912 - 030 - 500,
  ...
  CityBasedHotel(
    ...
    price: 98,
    rating: 5,
    address: "590 Marine Drive, Colombo 00300.",
    tel: 0112 - 375 - 375,
