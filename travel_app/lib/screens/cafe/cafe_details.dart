...
class CafeDetails extends StatefulWidget {
  ...
  _CafeDetailsState createState() => _CafeDetailsState();
}
...
class _CafeDetailsState extends State<CafeDetails> {
          ...
          children: <Widget>[
            Stack(
              children: <Widget>[
                Container(
                  ...
                  child: Hero(
                    tag: widget.bestcafe.imagePath,
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(20),
                      child: Image(
                        image: AssetImage(widget.bestcafe.imagePath),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
            ...
            Row(
              ...
              children: [
                ...
                if (widget.bestcafe.startTimes.isNotEmpty) ...[
                  Container(
                    padding: const EdgeInsets.all(1.0),
                    width: 60,
                    decoration: BoxDecoration(
                ...
                if (widget.bestcafe.startTimes.length > 1) ...[
                  Container(
                    padding: const EdgeInsets.all(1.0),
                    width: 60,
                    decoration: BoxDecoration(
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    IconButton(
                      onPressed: () {
                        _launchURL(widget.bestcafe.url);
                      },
                      icon: const Icon(Icons.search_rounded),
                      iconSize: 20,
  ...
  List<Widget> _buildFacilityButtons() {
    return [
      _buildFacilityButton(Icons.dining, "Dine"),
      _buildFacilityButton(Icons.local_bar, "Mocktails"),
      _buildFacilityButton(Icons.casino, "Board games"),
