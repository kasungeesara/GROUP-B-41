...
class _CoffeeDetailsState extends State<CoffeeDetails> {
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: [
                ...
                if (widget.coffee.startTimes.isNotEmpty) ...[
                  Container(
                    padding: const EdgeInsets.all(1.0),
                    width: 60,
                    decoration: BoxDecoration(
                ...
                if (widget.coffee.startTimes.length > 1) ...[
                  Container(
                    padding: const EdgeInsets.all(1.0),
                    width: 60,
                    decoration: BoxDecoration(
  ...
  List<Widget> _buildFacilityButtons() {
    return [
      _buildFacilityButton(Icons.fastfood_rounded, "Pastries & Snacks"),
      _buildFacilityButton(Icons.coffee_maker, "Coffee Options"),
      _buildFacilityButton(Icons.music_note, "Ambient Music"),
