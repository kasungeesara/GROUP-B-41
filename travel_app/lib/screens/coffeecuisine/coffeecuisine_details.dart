...
class CoffeeCuisineDetails extends StatefulWidget {
  // ignore: use_super_parameters
  const CoffeeCuisineDetails({
    Key? key,
    required this.name,
  }) : super(key: key);

  final CityCoffeeCuisine name;

  @override
  // ignore: library_private_types_in_public_api
  _CoffeeCuisineDetailsState createState() => _CoffeeCuisineDetailsState();
}

class _CoffeeCuisineDetailsState extends State<CoffeeCuisineDetails> {
  @override
